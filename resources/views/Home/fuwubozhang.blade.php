...
<script type="text/javascript" src="{{ asset('style/js/base.2fa0b3556624d4910689.js') }}"></script><script type="text/javascript" src="{{ asset('style/js/server_security.3c11adb69be7b09fe4b5.js') }}"></script><body>
<!--顶栏-->
    <!-- 春节通知  s -->
<!--    --><!--        <div class="year-2017">-->
