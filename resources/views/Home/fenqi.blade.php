...
<script>
    window.trackingConfig = {"page_type":"loan_index","pagetype":"loan_index"};
    </script>
<div class="festivelTip" id="festivelTip">
...
<div class="header">
    <div class="hd-top clearfix">
        ...
        <div class="search-box" style="visibility: hidden;">
            <div>
                <input type="text" class="search-input" placeholder="请输入要买的品牌、车型">
