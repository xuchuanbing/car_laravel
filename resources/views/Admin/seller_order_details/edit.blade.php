                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-border-form tpl-form-border-br" method="post" action="{{url('admin/seller_order_details/update')}}/{{$list->id}}">
								         {{ csrf_field() }}
									...
									<div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">卖家<span class="tpl-form-line-small-title"></span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" name="buyers_id" id="user-name" value="{{$list->buyers_id}}">
                                        </div>
                                    </div>
									<div class="am-form-group">
