            ...
            <div class="tpl-login-content">
                ...
                <form class="am-form tpl-form-line-form" action="/admin/doLogin" method="post">
                    ...
                    <div class="am-form-group">
                        <input type="text" class="tpl-form-input" id="user-name" name="email" placeholder="请输入账号">

                    </div>

                    <div class="am-form-group">
                        <input type="password" class="tpl-form-input" id="user-name" name="pass" placeholder="请输入密码">
