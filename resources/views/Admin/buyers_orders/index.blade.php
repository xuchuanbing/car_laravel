                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body  am-fr">
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <a href="{{ url("admin/buyers_orders/create") }}" type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <form method="get" action="{{ url('/admin/buyers_orders') }}">
                                {{ csrf_field() }}
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td class="am-text-middle">
                                                    <div class="tpl-table-black-operation">
                                                        <a href="{{ url('admin/buyers_orders') }}/{{ $vo->id }}/edit">
        ...
        function Del(id){
            e = confirm("确定是否删除？")
                if(e){
                    ...
                    form.action = "{{ url('admin/buyers_orders/destroy') }}/"+id
                    form.submit();
                }else{
                    return;
                }
