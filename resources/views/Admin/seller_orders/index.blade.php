                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body  am-fr">
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <a href="{{ url("admin/seller_orders/create") }}" type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <form method="get" action="{{ url('/admin/seller_orders') }}">
                                {{ csrf_field() }}
                                    ...
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black ">
                                        ...
                                        @foreach($list as $vo)
                                            <tr class="gradeX">
                                                ...
                                                <td class="am-text-middle">{{ $vo->order_id }}</td>
                                                <td class="am-text-middle">{{ $vo->commodity_id }}</td>
                                                <td class="am-text-middle">{{ $vo->yue_time }}</td>
                                                <td class="am-text-middle">{{ $vo->price }}</td>
                                                <td class="am-text-middle">
                                                    <div class="tpl-table-black-operation">
                                                        <a href="{{ url('admin/seller_orders') }}/{{ $vo->id }}/edit">
