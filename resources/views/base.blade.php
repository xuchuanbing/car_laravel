...
<head _tracker='{"pagetype":"index","abtest":"c2c_web_indexpage_test_a"}'>
    ...
    <script type="text/javascript" src="{{ asset('style/js/index.js') }}"></script>
    <script type="text/javascript" src="{{ asset('style/js/base.js') }}"></script>
    <script type="text/javascript" src="{{ asset('style/js/server_security.3c11adb69be7b09fe4b5.js') }}"></script>
    <script type="text/javascript" src="{{ asset('style/js/raven.min.js') }}" crossorigin="anonymous"></script>
    <script type="text/javascript" src="{{ asset('style/js/detail.ca8bd5131221316b9f1d.js') }}"></script>
</head>
        ...
        <div class="nav">
            <div class="w">
                ...
                <a class="fl active" baidu_alog="pc_index_top_tab&click&pc_index_top_tab_index_c"
                   href="{{url('/')}}"  data-gzlog="tracking_type=click&eventid=0010000000000007" title="瓜子二手车">首页</a>
