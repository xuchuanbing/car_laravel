...
<a baidu_alog='gpc_index_fastPick_brand&click&pc_index_fastPick_brand_dazhong_c#pc_index_fastPick&click&pc_index_fastPick_brand_c'  data-gzlog='tracking_type=click&eventid=0050080000000024&brand=dazhong' href="{{ url('home/buyers') }}?title=%大众% " class="i-dazhong" title="大众二手车">大众</a>
                                                                                    
<a baidu_alog='pc_index_fastPick_brand&click&pc_index_fastPick_brand_toyota_c#pc_index_fastPick&click&pc_index_fastPick_brand_c'  data-gzlog='tracking_type=click&eventid=0050080000000024&brand=toyota' href="{{ url('home/buyers') }}?title=%丰田% " class="i-toyota" title="丰田二手车">丰田</a>
                                                                                    
<a baidu_alog='pc_index_fastPick_brand&click&pc_index_fastPick_brand_honda_c#pc_index_fastPick&click&pc_index_fastPick_brand_c'  data-gzlog='tracking_type=click&eventid=0050080000000024&brand=honda' href="{{ url('home/buyers') }}?title=%本田% " class="i-honda" title="本田二手车">本田</a>
                                                                                    
<a baidu_alog='pc_index_fastPick_brand&click&pc_index_fastPick_brand_benz_c#pc_index_fastPick&click&pc_index_fastPick_brand_c'  data-gzlog='tracking_type=click&eventid=0050080000000024&brand=benz' href="{{ url('home/buyers') }}?title=%奔驰% " class="i-benz" title="奔驰二手车">奔驰</a>
                                                                                    
<a baidu_alog='pc_index_fastPick_brand&click&pc_index_fastPick_brand_bmw_c#pc_index_fastPick&click&pc_index_fastPick_brand_c'  data-gzlog='tracking_type=click&eventid=0050080000000024&brand=bmw' href="{{ url('home/buyers') }}?title=%宝马% " class="i-bmw" title="宝马二手车">宝马</a>
                                                                                    
<a baidu_alog='pc_index_fastPick_brand&click&pc_index_fastPick_brand_audi_c#pc_index_fastPick&click&pc_index_fastPick_brand_c'  data-gzlog='tracking_type=click&eventid=0050080000000024&brand=audi' href="{{ url('home/buyers') }}?title=%奥迪% " class="i-audi" title="奥迪二手车">奥迪</a>
</div>
            </div>
            <br>
            <div class="sx-price">
        ...
        <ul class="list-bigimg clearfix">
            ...
            <li clue_id="14200919">
                <div class="list-infoBox">
                    <a data-gzlog="tracking_type=click&eventid=0080140000000032&carid=14200919@0" baidu_alog='pc_index_tabSelect_detailCar&click&pc_index_tabSelect_new_sale_post_c' title='{{ $list[$k][$k]["title"] }}' target="_blank" class="imgtype" href="{{ url('/home/details') }}/{{ $vo->id }}" >
                        <img width="290" height="194" src='http://oslhf8hmf.bkt.clouddn.com/{{ $vo->picture }}' class="tpl-table-line-img" alt="{{ $vo->id }}">
                    </a>
                    <p class="infoBox">
                        <a data-gzlog="tracking_type=click&eventid=0080140000000032&carid=14200919@0" data-gzlog="tracking_type=click&eventid=0080140000000032&carid=14200919@0" baidu_alog='pc_index_tabSelect_detailCar&click&pc_index_tabSelect_new_sale_post_c' title='{{ $list[$k][$k]["title"] }}' href="{{ url('/home/details') }}/{{ $vo->id }}" target="_blank" class="info-title" >{{ $list[$k][$k]["title"] }}</a>
                    </p>
                    <p class="fc-gray">
                        <span class="">{{ $lists[$k][$k]["licensing"] }}</span><em class="shuxian">|</em>{{ $lists[$k][$k]["mileage"] }}                            
                    </p>
                    <p class="priType-s">
                        <em class="tag-yellow">超值</em>
                        <span>
                            <i class="fc-org priType">{{ $lists[$k][$k]["price"] }}</i>
                        </span>
                        <s>{{ $vo->price }}</s>
                    </p>
                </div>
