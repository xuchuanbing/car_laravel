                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body  am-fr">
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <a href="<?php echo e(url("admin/seller/create")); ?>" type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <form method="get" action="<?php echo e(url('/admin/seller')); ?>">
                                    ...
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black ">
                                        ...
                                        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="gradeX">
                                                ...
                                                <td class="am-text-middle"><?php echo e($vo->selleruser_id); ?></td>
                                                <td class="am-text-middle"><?php echo e($vo->car); ?></td>
                                                <td class="am-text-middle"><?php echo e($vo->car_id); ?></td>
                                                <td class="am-text-middle"><?php echo e($vo->datatime); ?></td>
                                                <td class="am-text-middle"><?php echo e($vo->mileage); ?></td>
                                                <td class="am-text-middle"><?php echo e($vo->address); ?></td>
                                                <td class="am-text-middle"><?php echo e($vo->content); ?></td>
        ...
        function Del(id){
            e = confirm("确定是否删除？")
                if(e){
                    ...
                    form.action = "<?php echo e(url('admin/seller/destroy')); ?>/"+id
                    form.submit();
                }else{
                    return;
                }
