...
<div class="person-main">
    ...
    <ul class="user-menu">
        <li><a data-gzlog="tracking_type=click&amp;eventid=1016123400000001" href="<?php echo e(url('home/person/userstore')); ?>">收藏车辆</a></li>
        <li><a data-gzlog="tracking_type=click&amp;eventid=1016123400000003" href="<?php echo e(url('home/person')); ?>">降价提醒</a></li>
        <li><a data-gzlog="tracking_type=click&amp;eventid=1016123400000006" class="active" href="<?php echo e(url('home/person/userhistory')); ?>">浏览记录</a></li>
    </ul>
</div>    <!-- 左菜单 e -->
    ...
    <div class="person-source js-carList active">
        <ul class="person-list person-list-price clearfix">
         <?php $__currentLoopData = $buyers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $K=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		  ...
		  <img src='http://oslhf8hmf.bkt.clouddn.com/<?php echo e($motor_details[$K]->picname); ?>'></a>
		  <a href="<?php echo e(url('home/userhistory/del')); ?>/<?php echo e($v->uid); ?>" class="icon-delete js-delete-store-click">删除</a>
		  <a class="info-name" href="https://www.guazi.com/bj/61798df0023f9ce0x.htm"><?php echo e($motor_details[$K]->title); ?></a><p class="info-mile"><?php echo e($detection_mes[$K]->licensing); ?>上牌<em>|</em>行驶<?php echo e($detection_mes[$K]->mileage); ?></p>
		  <p class="info-price"><span class="price-curr"><?php echo e($detection_mes[$K]->price); ?></span><span class="price-through"><?php echo e($detection[$K]->price); ?></span></p></li>
...
<div class="pop-box pop-box-person js-delete-pop">
    ...
    <p class="person-btn">
        ...
        <a data-gzlog="tracking_type=click&amp;eventid=1016123400000007" class="btn-primary js-delete-store" href="javascript:void(0)">删除车辆</a>
    </p>
</div>
...
<div class="right-nav" id="rightNav">
    ...
    <div class="history-source-no active">
        ...
        <div class="history-btn2"><a href="https://www.guazi.com/bj/userhistory#"></a></div>
    </div>
    <!-- 无车源 start -->
</div>        </div>
        ...
        <a href="https://www.guazi.com/bj/userhistory#jstop"><div class="fix-icon fix-icon-6" style="display:none" data-gzlog="tracking_type=click&amp;eventid=1015123400000016"></div></a>
