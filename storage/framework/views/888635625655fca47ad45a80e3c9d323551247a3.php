...
<div class="list-wrap js-post">
    ...
    <div class="crumbs-search" id="bread">
        <div class="crumbs">
            <a href='<?php echo e(url('')); ?>'>首页</a>&gt;北京二手车
    ...
    <div class="screen">
        ...
        <dl class="clearfix">
            ...
            <dd>
                ...
                <span class="a-box">
                    <!-- 不限 -->
                    <a class="active"
                       href="<?php echo e(url('home/buyers')); ?>">不限
                   </a>
                    <!-- 热门品牌 -->
                    ...
                    <a data-gzlog=tracking_type=click&eventid=0070000000000045&filter=brand&brand=dazhong&type=hot href="<?php echo e(url('home/buyers')); ?>?title=%<?php echo e($v->brand_name); ?>% "><?php echo e($v->brand_name); ?></a>
        ...
        <dl class="clearfix">
            ...
            <dd>
                <div class="dd-top">
                <span class="a-box">
                    <a class="active" href="<?php echo e(url('home/buyers')); ?>">不限</a> 
                    <?php $__currentLoopData = $audi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a data-gzlog=tracking_type=click&eventid=0070000000000045&filter=tag&tag=suteng&type=hot href="/bj/suteng/#bread"><?php echo e($v->brand_name); ?></a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                                                    
            ...
            <dd>
                <div class="dd-top">
                    <a class="active" data-gzlog=tracking_type=click&eventid=0070000000000045&filter=price_index&price_index=0
                        href="<?php echo e(url('home/buyers')); ?>">不限</a>
                    <a
    ...
    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <li>
            <a href="<?php echo e(url('/home/details')); ?>/<?php echo e($v->id); ?>" target="_blank" class="car-a"
               data-gzlog="tracking_type=click&eventid=0120000000000057&carid=12192131@0">
                <img src='http://oslhf8hmf.bkt.clouddn.com/<?php echo e($v->picname); ?>'>
                <div class="t"><?php echo e($v->title); ?></div>
                <!-- 年款里程 -->
                <div class="t-i"><?php echo e($lists[$k]->licensing); ?><span class="icon-pad">|</span><?php echo e($lists[$k]->mileage); ?></div>
                <div class="t-price">
                    <!-- 价格 -->
                    <p><span style="font-size:23px"><?php echo e($lists[$k]->price); ?></span></p>
                    <!-- 标签 -->
                    <em class='line-through'><?php echo e($detection[$k]->price); ?></em></div>
            </a>
