...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/center.css')); ?>">
    ...
    <script type="text/javascript" src="<?php echo e(asset('style/js/list_v4.4365aad438498c155300.js')); ?>"></script>
...
<?php if(session("phone")): ?>
        ...
        <div class="uc js-uc js-uc-new" data-gzlog="tracking_type=click&eventid=1015123400000003">
            ...
            <div class="uc-app" style=display:none>
                <a href="<?php echo e(url('/home/userstore')); ?>" class="js-loginElem1" data-gzlog="tracking_type=click&eventid=1015123400000004">收藏车辆</a>
                <a href="<?php echo e(url('/home/userreduce')); ?>" class="js-loginElem2"
                   data-gzlog="tracking_type=click&eventid=1015123400000005">降价提醒</a>
                <a href="<?php echo e(URL('/home/person/userhistory')); ?>" class="js-loginElem3"
                   data-gzlog="tracking_type=click&eventid=1015123400000006">浏览记录</a>
                <a href="<?php echo e(URL('/home/out')); ?>" class="js-logout js-loginElem4"
...
<?php endif; ?>
        ...
        <div class="nav-list">
            <a class="fl "
               href="<?php echo e(url('/home/wenda1')); ?>" data-gzlog="tracking_type=click&eventid=0010000000000012" title="瓜子问答">瓜子问答</a>
            ...
            <a class="fl " baidu_alog="pc_index_top_tab&click&pc_index_top_tab_intro_c"
               href="<?php echo e(url('/home/fuwubozhang')); ?>" data-gzlog="tracking_type=click&eventid=0010000000000010">瓜子服务</a>
            <a class="fl " baidu_alog="pc_index_top_tab&click&pc_index_top_tab_sell_c"
               href="<?php echo e(url('/home/seller')); ?>" data-gzlog="tracking_type=click&eventid=0010050000000009">我要卖车</a>
            <a class="fl active" baidu_alog="pc_index_top_tab&click&pc_index_top_tab_buy_c"
               href="<?php echo e(url('/home/buyers')); ?>" data-gzlog="tracking_type=click&eventid=0010000000000008">我要买车</a>
            <a class="fl " baidu_alog="pc_index_top_tab&click&pc_index_top_tab_index_c"
               href="<?php echo e(url('/')); ?>" data-gzlog="tracking_type=click&eventid=0010000000000007">首页</a>
        </div>
    </div>
</div>
