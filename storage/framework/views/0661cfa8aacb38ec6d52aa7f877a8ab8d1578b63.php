...
<script>
    var logged = false;
</script><script type="text/javascript" src="<?php echo e(asset('style/js/base.2fa0b3556624d4910689.js')); ?>"></script><script type="text/javascript" src="<?php echo e(asset('style/js/about_us.8c2b843ad6a8708a9f75.js')); ?>"></script>
<body class="index">
<!-- 顶栏 -->
    <!-- 春节通知  s -->
<!--    --><!--        <div class="year-2017">-->
...
<div class="w clearfix">
    <div class="j-l">
        <ul id="tab">
            ...
            <li>
                <div class="tit-big">
                    <span class="border-bottom"><i class="icon2"></i>加入我们</span>
                    <span class="t-s-box">
                        <a href="/bj/join" class="tit-small-a">社会招聘</a>
                        <a href="/bj/join?kind=XJ" class="tit-small-a">校园招聘</a>
                    </span>
                </div>
            </li>
            <li class="on">
