...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('assets/i/favicon.png')); ?>">
    <link rel="apple-touch-icon-precomposed" href="<?php echo e(asset('assets/i/app-icon72x72@2x.png')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/amazeui.datatables.min.css')); ?>" />
    ...
    <div class="am-g tpl-g">
        ...
        <header>
            ...
            <div class="am-fl tpl-header-logo">
                <a href="javascript:;"><img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt=""></a>
            </div>
            <!-- 右侧内容 -->
                ...
                <div class="am-fr tpl-header-navbar">
                    <ul>
                        ...
                        <li class="am-text-sm tpl-header-navbar-welcome">
                            <a href="javascript:;">欢迎你, <span> <?php echo e(Session::get('key')); ?></span> </a>
                        </li>
                        ...
                        <li class="am-dropdown tpl-dropdown" data-am-dropdown>
                            ...
                            <ul class="am-dropdown-content tpl-dropdown-content">
                                <li class="tpl-dropdown-menu-messages">
                                    <a href="javascript:;" class="tpl-dropdown-menu-messages-item am-cf">
                                        <div class="menu-messages-ico">
                                            <img src="<?php echo e(asset('assets/img/user04.png')); ?>" alt="">
                                        </div>
                                ...
                                <li class="tpl-dropdown-menu-messages">
                                    <a href="javascript:;" class="tpl-dropdown-menu-messages-item am-cf">
                                        <div class="menu-messages-ico">
                                            <img src="<?php echo e(asset('assets/img/user02.png')); ?>" alt="">
                                        </div>
                                        <div class="menu-messages-time">
                                            5天前
                                        </div>
        ...
        <div class="left-sidebar">
            ...
            <div class="tpl-sidebar-user-panel">
			  ...
			  <?php if( Session::get('key2') =="1"): ?>管理员 <?php else: ?> 普通用户 <?php endif; ?>
          </span>
            ...
            <ul class="sidebar-nav">
                <li class="sidebar-nav-link">
                    ...
                    <a href="<?php echo e(url("/admin")); ?>" class="active">
                ...
                <li class="sidebar-nav-link">
                    ...
                    <ul class="sidebar-nav sidebar-nav-sub">
                        ...
                        <li class="sidebar-nav-link">
                            <a href="<?php echo e(url('admin/selleruser')); ?>">
                                <span class="am-icon-angle-right sidebar-nav-link-logo"></span> 前台卖家用户管理
                            </a>
                        </li>
                        <li class="sidebar-nav-link">
                            <a href="<?php echo e(url('admin/usercontrol')); ?>">
				   ...
				   <li class="sidebar-nav-link">
                    ...
                    <ul class="sidebar-nav sidebar-nav-sub">
						...
						<li class="sidebar-nav-link">
                            <a href="<?php echo e(url('admin/seller_order_details')); ?>">
				  ...
				  <li class="sidebar-nav-link">
                    ...
                    <ul class="sidebar-nav sidebar-nav-sub">
                        ...
                        <li class="sidebar-nav-link">
                            <a href="<?php echo e(url("admin/audi")); ?>">
