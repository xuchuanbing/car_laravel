...
<div class="person-main">
    ...
    <ul class="user-menu">
        <li><a data-gzlog="tracking_type=click&amp;eventid=1016123400000001" class="active" href="<?php echo e(url('home/person/userstore')); ?>">收藏车辆</a></li>
        <li><a data-gzlog="tracking_type=click&amp;eventid=1016123400000003" href="<?php echo e(url('home/person')); ?>">降价提醒</a></li>
        <li><a data-gzlog="tracking_type=click&amp;eventid=1016123400000006" href="<?php echo e(url('home/person/userhistory')); ?>">浏览记录</a></li>
    </ul>
</div>    <!-- 左菜单 e -->
    ...
    <div class="person-source js-carList active">
        <ul class="person-list person-list-price clearfix">
         <?php $__currentLoopData = $buyers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $K=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="list-infoBox js-oneInfo" puid="3001961610" clueid="14549078">
                <a href="https://www.guazi.com/bj/61798df0023f9ce0x.htm" class="info-img">
                  <img src='http://oslhf8hmf.bkt.clouddn.com/<?php echo e($motor_details[$K]->picname); ?>'>
                </a>
